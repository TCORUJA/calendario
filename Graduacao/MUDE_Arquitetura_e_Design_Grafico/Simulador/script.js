...
function calcularParte07() {
    ...
    /* Verificar se o aluno precisa de recuperação ou não */
    if (atividade1 <= 20 && atividade2 <= 40 && atividade3 <= 40) {
        var soma = atividade1 + atividade2 + atividade3;
        var somaDecimal = Math.round(soma * 10) / 10;
    ...
    /* Verificar se os valores colocados estão dentro do permitido para a avaliação */
    else if (atividade1 > 20 && atividade2 > 40 && atividade3 > 40) {
        window.alert("Verifique nos Projetos se as notas do: \n\n\Projeto 1 está entre 0 e 20\n\Projeto 2 está entre 0 e 40\n\Apresentação do Projeto está entre 0 e 40");
    }
    else if (atividade1 > 20 && atividade2 > 40) {
        window.alert("Verifique nos Projetos se as notas do: \n\n\Projeto 1 está entre 0 e 20\n\Projeto 2 está entre 0 e 40");
    }
    else if (atividade1 > 20 && atividade3 > 40) {
        window.alert("Verifique nos Projetos se as notas do: \n\n\Projeto 1 está entre 0 e 20\n\Apresentação do Projeto está entre 0 e 40");
    }
    else if (atividade2 > 40 && atividade3 > 40) {
        window.alert("Verifique nos Projetos se as notas do: \n\n\Projeto 2 está entre 0 e 40\n\Apresentação do Projeto está entre 0 e 40");
    }
    else if (atividade1 > 20) {
        window.alert("Verifique nos Projetos se a nota do Projeto 1 está entre 0 e 20");
    }
    else if (atividade2 > 40) {
        window.alert("Verifique nos Projetos se a nota do Projeto 2 está entre 0 e 40");
    }
    else if (atividade3 > 40) {
        window.alert("Verifique nos Projetos se a nota da Apresentação do Projeto está entre 0 e 40");
    }
...
function calcularMediaFinal01() {
    ...
    if (atividade1 <= 150 && atividade2 <= 50 && atividade3 <= 50) {
    ...
    else if (atividade1 > 150 && atividade2 > 50 && atividade3 > 50) {
        window.alert("Verifique se as notas de: \n\n\AC está entre 0 e 150\n\Prova Integradora está entre 0 e 50\n\Prova Substitutiva está entre 0 e 50");
    }
    else if (atividade1 > 150 && atividade2 > 50) {
        window.alert("Verifique se as notas de: \n\n\AC está entre 0 e 150\n\Prova Integradora está entre 0 e 50");
    }
    else if (atividade1 > 150 && atividade3 > 50) {
        window.alert("Verifique se as notas de: \n\n\AC está entre 0 e 150\n\Prova Substitutiva está entre 0 e 50");
    }
    else if (atividade2 > 50 && atividade3 > 50) {
        window.alert("Verifique se as notas de: \n\Prova Integradora está entre 0 e 50\n\Prova Substitutiva está entre 0 e 50");
    }
    else if (atividade1 > 150) {
        window.alert("Verifique se a nota de AC está entre 0 e 150");
    }
    else if (atividade2 > 50) {
        window.alert("Verifique se a nota de Prova Integradora está entre 0 e 50");
    }
    else if (atividade3 > 50) {
        window.alert("Verifique se a nota de Prova Substitutiva está entre 0 e 50");
    }
